...
export const OutlinedTooltipToggleDelay = () => {
  return (
      ...
      <div className='flex flex-wrap gap-4'>
        {positions.map((position) => (
          <Tooltip
            ...
            touchDelay={1000}
            position={position}
            content='This is a tooltip with a button'
          >
      ...
      <div className='flex flex-wrap gap-4'>
        {positions.map((position) => (
          <Tooltip
            ...
            touchDelay={1000}
            position={position}
            content='This is a tooltip with a text'
          >
            10.000
          </Tooltip>
        ))}
      ...
      <div className='not-prose flex flex-wrap gap-4'>
        {positions.map((position) => (
          <Tooltip
            ...
            touchDelay={1000}
            position={position}
            content='This is a tooltip with an inline link'
          >
      ...
      <div className='flex flex-wrap gap-4'>
        {positions.map((position) => (
          <Tooltip
            ...
            touchDelay={1000}
            position={position}
            content='This is a tooltip with a link (next/link)'
          >
...
export default OutlinedTooltipToggleDelay;

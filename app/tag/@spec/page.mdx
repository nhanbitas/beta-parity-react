...
| `--par-color-icon-tag`                 | Tag icon                 | Any               | `.tag .icon`                |
| `--par-color-bg-tag-remove-hovered`    | Remove button background | Hovered           | `.tag .remove-btn:hover`    |
| `--par-color-bg-tag-remove-pressed`    | Remove button background | Pressed           | `.tag .remove-btn:active`   |
| `--par-color-bg-tag-remove-disabled`   | Remove button background | Disabled          | `.tag .remove-btn:disabled` |
| `--par-color-text-tag-remove`          | Remove button text/icon  | Any               | `.tag .remove-btn`          |
| `--par-color-text-tag-remove-disabled` | Remove button text/icon  | Disabled          | `.tag .remove-btn:disabled` |

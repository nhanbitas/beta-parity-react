...
<Image src={imageSrc.accordion} alt='accordion' />
...
<Image src={imageSrc.anatomy1} alt='anatomy1' />
...
<Image src={imageSrc.anatomy2} alt='anatomy2' style={{ objectFit: 'contain', objectPosition: 'center' }} />
...
<Image src={imageSrc.contained} alt='contained' />
<Image src={imageSrc.flush} alt='flush' />

...
<main className="prose flex min-h-screen w-full flex-col gap-8 p-8 sm:px-12 md:px-24 2xl:px-48">

## Installation

<CodeBlock language='bash'>npm install beta-parity-react</CodeBlock>

## Usage

- Wrap your application code with ThemeProvider in your main entry point (e.g., `index.tsx` or `App.tsx`):

...
<Image src={imageSrc.menu} alt='menu' />
...
<Image src={imageSrc.hidden} alt='hidden' />

##### Visible

- The menu is presented to the user to allow for interaction.

<Image src={imageSrc.visible} alt='visible' />
...
<Image src={imageSrc.selectedSubtle} alt='selectedSubtle' />
<Image src={imageSrc.selectedSubtleHovered} alt='selectedSubtleHovered' />
<Image src={imageSrc.selectedPronounced} alt='selectedPronounced' />
<Image src={imageSrc.selectedPronouncedHovered} alt='selectedPronouncedHovered' />

### Filter input

This sub-component has the same states as [[Search input]].

<Image src={imageSrc.filterInput} alt='filterInput' />
...
<Image src={imageSrc.groupLabelOn} alt='groupLabelOn' />

<Image src={imageSrc.groupLabelOff} alt='groupLabelOff' />
...
<Image src={imageSrc.scrollButton} alt='scrollButton' />
...
<Image src={imageSrc.accent} alt='accent' />
...
<Image src={imageSrc.subtle} alt='subtle' />

<Image src={imageSrc.pronounced} alt='pronounced' />
...
<Image src={imageSrc.filterInput} alt='filter input' />

<Image src={imageSrc.filterInput2} alt='filter input' />
...
<Image src={imageSrc.position} alt='position' />
<Image src={imageSrc.position2} alt='position2' />

...
| `--par-color-bg-menu-item-selected-subtle`        | Menu item background         | Selected (subtle)                                 | `.menu-item.selected-subtle`             |
| `--par-color-bg-menu-item-selected-pronounced`    | Menu item background         | Selected (pronounced)                             | `.menu-item.selected-pronounced`         |
| `--par-color-bg-menu-item-disabled`               | Menu item background         | Disabled                                          | `.menu-item:disabled`                    |
| `--par-color-text-menu-item`                      | Menu item text               | Default/Enabled                                  | `.menu-item`                             |
| `--par-color-text-menu-item-disabled`             | Menu item text               | Disabled                                          | `.menu-item:disabled`                    |
| `--par-color-text-menu-item-selected`             | Menu item text               | Selected                                          | `.menu-item.selected`                    |
| `--par-color-icon-menu-item`                      | Menu item icon               | Default/Enabled                                  | `.menu-item .icon`                       |
| `--par-color-icon-menu-item-disabled`             | Menu item icon               | Disabled                                          | `.menu-item:disabled .icon`              |
...
| **defaultOpen**  | boolean              | _false_     | Default open state (uncontrolled)            |
| **onOpenChange** | function (open)      |             | Callback when open state changes             |
| **placement**    | string               | _'bottom'_  | Menu placement (top, bottom, etc.)           |
...
| **Prop**       | **Type**            | **Default** | **Description**                             |
| -------------- | ------------------- | ----------- | ------------------------------------------- |
| **label**      | string \| ReactNode |             | Menu item label                             |
| **icon**       | ReactNode           |             | Icon for menu item                          |
| **disabled**   | boolean             | _false_     | Disable the menu item                       |
| **onClick**    | function (event)    |             | Callback when item is clicked               |
| **...liProps** | HTMLLIElement props |             | All native li props (className, style, ...) |

> **_Note:_** _Menu_ and _MenuItem_ **inherit** all native props from **HTMLDivElement** and **HTMLLIElement** respectively.

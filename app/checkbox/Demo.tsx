  ...
  return (
    <>
      ...
      <CheckboxGroup onChange={(value: any) => console.log('value root', value)}>
        ...
        <Checkbox value='value-2' label='value 2' />
        <Checkbox value='value-3' label='value 3' />
        <CheckboxGroup value='value-4' label='value 4' onChange={(value: any) => console.log('value 4', value)}>
          <Checkbox value='value-4.1' label='value 4.1' />
          <Checkbox value='value-4.2' label='value 4.2' />
        </CheckboxGroup>
        <CheckboxGroup value='value-5' label='value 5' onChange={(value: any) => console.log('value 5', value)}>
          <Checkbox value='value-5.1' label='value 5.1' />
          <Checkbox value='value-5.2' label='value 5.2' />
          <CheckboxGroup value='value-5.3' label='value 5.3' onChange={(value: any) => console.log('value 5.3', value)}>
            ...
            <CheckboxGroup
              value='value-5.3.4'
              label='value 5.3.4'
              onChange={(value: any) => console.log('value 5.3.4', value)}
            >

...
|---------------------------------------- | ---------------------------- | ------------------------- | ------------------- |
| `--par-color-bg-field-enabled`          | Select field background      | Enabled                   | `.select:enabled` |
| `--par-color-bg-field-hovered`          | Select field background      | Hovered                   | `.select:hover` |
| `--par-color-bg-field-disabled`         | Select field background      | Disabled                  | `.select:disabled` |
| `--par-color-bg-field-readonly`         | Select field background      | Readonly                  | `.select[readonly]` |
| `--par-color-bg-field-invalid`          | Select field background      | Invalid/Error             | `.select.invalid` |
| `--par-color-border-field-enabled`      | Select field border          | Enabled                   | `.select:enabled` |
| `--par-color-border-field-hovered`      | Select field border          | Hovered                   | `.select:hover` |
| `--par-color-border-field-disabled`     | Select field border          | Disabled                  | `.select:disabled` |
| `--par-color-border-field-invalid`      | Select field border          | Invalid/Error             | `.select.invalid` |
| `--par-color-border-field-focused`      | Select field border          | Focused                   | `.select:focus` |
| `--par-color-text-field-placeholder`    | Placeholder text             | Any                       | `.select::placeholder` |
| `--par-color-text-field-filled`         | Select field text            | Filled                    | `.select` |
| `--par-color-text-field-label`          | Label text                   | Any                       | `.select-label` |
| `--par-color-text-field-disabled`       | Select field text            | Disabled                  | `.select:disabled` |
| `--par-color-text-field-readonly`       | Select field text            | Readonly                  | `.select[readonly]` |
| `--par-color-text-field-invalid`        | Select field text            | Invalid/Error             | `.select.invalid` |
| `--par-color-icon-field-button-enabled` | Icon color (button enabled)  | Enabled                   | `.select .icon-button:enabled` |
| `--par-color-icon-field-button-hovered` | Icon color (button hovered)  | Hovered                   | `.select .icon-button:hover` |
| `--par-color-icon-field-button-pressed` | Icon color (button pressed)  | Pressed                   | `.select .icon-button:active` |
| `--par-color-icon-field-button-disabled`| Icon color (button disabled) | Disabled                  | `.select .icon-button:disabled` |
...
| **multiple**      | boolean                   | _false_     | Allow multiple selection          |
| **disabled**      | boolean                   | _false_     | Disable the select                |
| **placeholder**   | string                    |             | Placeholder text                  |
| **...InputProps** | [See Input](../BaseInput) |             | Inherits all props from **Input** |

> **_Note:_** _Select_ **inherits** all props from **Input** and the native **input/select** element. See [Input documentation](../BaseInput) for full details on available props and tokens.
